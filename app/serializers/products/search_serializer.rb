class Products::SearchSerializer < ProductSerializer
	...
	def details
		if object.prices.exists?
			...
			{ max: prices.first.price, max_id: prices.first.id, min: prices.last.price, min_pic: prices.last.image, min_id: prices.last.id, 
				min_username: prices.last.user.username, min_userid: prices.last.user.id, 
